...
export const productionContainerModule = new ContainerModule((bind, unbind, isBound, rebind) => {
    ...
    const workspaceServiceClient = new WorkspaceServiceClient("content-service:8080", grpc.credentials.createInsecure())
    bind(WorkspaceServiceClient).toConstantValue(workspaceServiceClient);
    const idePluginServiceClient = new IDEPluginServiceClient("content-service:8080", grpc.credentials.createInsecure())
